...
void MX_LTDC_Init(void)
{
  ...
  pLayerCfg.WindowX1 = LCD_WITH;
  pLayerCfg.WindowY0 = 0;
  pLayerCfg.WindowY1 = LCD_HIGH;
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_12|GPIO_PIN_11
                          |GPIO_PIN_10|GPIO_PIN_9|GPIO_PIN_0|GPIO_PIN_7
