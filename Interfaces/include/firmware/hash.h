...
typedef firmware_status_t (*hash_provider_update_fn)(void *context, const void *data, size_t size);
/** 完成计算，并写入恰好 FIRMWARE_SHA256_DIGEST_SIZE 字节。 */
typedef firmware_status_t (*hash_provider_finish_fn)(void *context,
