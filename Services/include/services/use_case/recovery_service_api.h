 ...
 * @brief Incremental fallback-slot validation and candidate selection API.
 */
...
/**
 * Start scanning both fixed APP/GUI pairs and selecting a recovery candidate.
...
/** Advance one candidate load, validation step, or selection step. */
...
/** Return the uncommitted selected candidate after a successful scan. */
