...
/** Caller-owned dependencies and work buffer for active-pair validation. */
typedef struct
{
...
typedef enum
{
    ...
    ACTIVE_VALIDATION_STAGE_RESET_APP_CRC,
    ACTIVE_VALIDATION_STAGE_READ_APP,
    ACTIVE_VALIDATION_STAGE_FINISH_APP_CRC,
    ACTIVE_VALIDATION_STAGE_RESET_GUI_CRC,
    ACTIVE_VALIDATION_STAGE_READ_GUI,
    ACTIVE_VALIDATION_STAGE_FINISH_GUI_CRC
