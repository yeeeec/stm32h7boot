...
#define UPDATE_SOURCE_CANDIDATE 0U
#define UPDATE_SOURCE_ROLLBACK  1U
    ...
    _Static_assert(sizeof(update_journal_record_t) == 112U, "update journal ABI must remain fixed");
